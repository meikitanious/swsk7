<script>
  ...
  let logosPerView = 0;
  let darkMode = false;
  let hlsLink = "https://customer-si5cxun7zm99ttrb.cloudflarestream.com/38201dc5c5d26f789caf61e77babb163/manifest/video.m3u8";
  let hlsThumbNail ='';
  onMount(() => {
...
<div class="main-page">
  <section class="hero">
    ...
    loop
    >
      <vds-hls autoplay loading="eager" poster="{hlsThumbnail}">
        <video src={hlsLInk}></video>
      </vds-hls>
    </vds-media>    
