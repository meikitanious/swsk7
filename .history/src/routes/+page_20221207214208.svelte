...
<div class="main-page">
  <section class="hero">
    <video autoplay loop muted playsinline style="pointer-events: none;" id="video">
      <source src="assets/images/whales.mp4" type="video/mp4"  />
      <source src="assets/images/whales.webm" type="video/webm" />
      <source src="assets/images/whales.ogv" type="video/ogv" />
  </video>
